...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<!-- <p>\r\n  login works!\r\n  <button (click)=\"gotoHomePage()\">Home</button>\r\n</p> -->\r\n<mat-progress-bar *ngIf=\"isDataLoading\" mode=\"indeterminate\" style=\"position: absolute;top:0px\"></mat-progress-bar>\r\n<div class=\"loginMainCon\">\r\n  <mat-card style=\"width: 20%;max-width: 300px;min-width: 250px;\">\r\n    <mat-tab-group md-stretch-tabs>\r\n      <!-- ********** FOR LOGIN ********  -->\r\n      <mat-tab label=\"Login\">\r\n        <!-- <form class=\"example-form\"> -->\r\n          <div>\r\n            <mat-form-field style=\"width: 100%;\">\r\n              <mat-label>select country</mat-label>\r\n              <mat-select  (selectionChange)=\"onLoginCountrySelection($event.value)\">\r\n                <mat-option *ngFor=\"let country of totalCountry\" [value]=\"country\">\r\n                  {{country}}\r\n                </mat-option>\r\n              </mat-select>\r\n            </mat-form-field>\r\n          </div>\r\n  \r\n          <div>\r\n            <mat-form-field style=\"width: 100%;\">\r\n              <mat-label>select state</mat-label>\r\n              <mat-select (selectionChange)=\"onLoginStateSelection($event.value)\">\r\n                <mat-option *ngFor=\"let state of totalStates\" [value]=\"state.name\">\r\n                  {{state.name}}\r\n                </mat-option>\r\n              </mat-select>\r\n            </mat-form-field>\r\n          </div>\r\n          <div>\r\n            <mat-form-field style=\"width: 100%;\">\r\n              <mat-label>select District</mat-label>\r\n              <mat-select (selectionChange)=\"onLoginDistSelection($event.value)\">\r\n                <mat-option *ngFor=\"let dist of totalDist\" [value]=\"dist\">\r\n                  {{dist}}\r\n                </mat-option>\r\n              </mat-select>\r\n            </mat-form-field>\r\n          </div>\r\n          <div>\r\n            <mat-form-field style=\"width: 100%;\">\r\n              <mat-label>select school</mat-label>\r\n              <mat-select (selectionChange)=\"onLoginschoolSelection($event.value)\">\r\n                <mat-option *ngFor=\"let dist of allDistricSchool\" [value]=\"dist.data().schoolName\">\r\n                  {{dist.data().schoolName}}\r\n                </mat-option>\r\n              </mat-select>\r\n            </mat-form-field>\r\n          </div>\r\n        <div>\r\n          <mat-form-field class=\"example-full-width\" style=\"width: 100%;\">\r\n            <mat-label>username</mat-label>\r\n            <input matInput placeholder=\"username\" value=\"\" [(ngModel)]=\"loginObj.username\"  autocomplete=\"off\">\r\n          </mat-form-field>\r\n        </div>\r\n        <div>\r\n          <mat-form-field class=\"example-full-width\" style=\"width: 100%;\">\r\n            <mat-label>password</mat-label>\r\n            <input matInput placeholder=\"password\" [(ngModel)]=\"loginObj.password\" value=\"\" autocomplete=\"off\">\r\n          </mat-form-field>\r\n        </div>\r\n        <div style=\"text-align: center;margin-bottom: 5px;\">\r\n          <button mat-raised-button (click)=\"loginUser()\">\r\n            login\r\n          </button>\r\n        </div>\r\n        <!-- </form> -->\r\n      </mat-tab>\r\n\r\n      <!-- ********** FOR REGISTRATION ********  -->\r\n      <mat-tab label=\"Register\">\r\n        <!-- <form class=\"example-form\"> -->\r\n        <div>\r\n          <mat-form-field style=\"width: 100%;\">\r\n            <mat-label>select country</mat-label>\r\n            <mat-select [(ngModel)]=\"selectedcountry\" (selectionChange)=\"onCountrySelection($event.value)\">\r\n              <mat-option *ngFor=\"let country of totalCountry\" [value]=\"country\">\r\n                {{country}}\r\n              </mat-option>\r\n            </mat-select>\r\n          </mat-form-field>\r\n        </div>\r\n\r\n        <div>\r\n          <mat-form-field style=\"width: 100%;\">\r\n            <mat-label>select state</mat-label>\r\n            <mat-select (selectionChange)=\"onStateSelection($event.value)\">\r\n              <mat-option *ngFor=\"let state of totalStates\" [value]=\"state.name\">\r\n                {{state.name}}\r\n              </mat-option>\r\n            </mat-select>\r\n          </mat-form-field>\r\n        </div>\r\n        <div>\r\n          <mat-form-field style=\"width: 100%;\">\r\n            <mat-label>select District</mat-label>\r\n            <mat-select (selectionChange)=\"onDistSelection($event.value)\">\r\n              <mat-option *ngFor=\"let dist of totalDist\" [value]=\"dist\">\r\n                {{dist}}\r\n              </mat-option>\r\n            </mat-select>\r\n          </mat-form-field>\r\n        </div>\r\n\r\n        <div>\r\n          <mat-form-field class=\"example-full-width\" style=\"width: 100%;\">\r\n            <mat-label>Name</mat-label>\r\n            <input matInput placeholder=\"Name\" [(ngModel)]=\"registerObj.schoolName\" value=\"\" autocomplete=\"off\">\r\n          </mat-form-field>\r\n        </div>\r\n        <div>\r\n          <mat-form-field class=\"example-full-width\" style=\"width: 100%;\">\r\n            <mat-label>Address</mat-label>\r\n            <input matInput placeholder=\"address\"[(ngModel)]=\"registerObj.address\"  value=\"\" autocomplete=\"off\">\r\n          </mat-form-field>\r\n        </div>\r\n        <div>\r\n          <mat-form-field class=\"example-full-width\" style=\"width: 100%;\">\r\n            <mat-label>username</mat-label>\r\n            <input matInput placeholder=\"username\" [(ngModel)]=\"registerObj.username\" value=\"\" autocomplete=\"off\">\r\n          </mat-form-field>\r\n        </div>\r\n        <div>\r\n          <mat-form-field class=\"example-full-width\" style=\"width: 100%;\">\r\n            <mat-label>password</mat-label>\r\n            <input matInput placeholder=\"password\" [(ngModel)]=\"registerObj.password\"  [value]=\"registerObj.password\" autocomplete=\"off\">\r\n            \r\n          </mat-form-field>\r\n        </div>\r\n        <div style=\"text-align: center;margin-bottom: 5px;\">\r\n          <button mat-raised-button (click)=\"registerUser()\">\r\n            Register\r\n          </button>\r\n        </div>\r\n        <!-- </form> -->\r\n      </mat-tab>\r\n    </mat-tab-group>\r\n  </mat-card>\r\n</div>");
...
/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/permission/addpermission.dialog.html":
/*!*******************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/components/permission/addpermission.dialog.html ***!
  \*******************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"loader\" *ngIf=\"isDataLoaded\">\r\n  <mat-spinner></mat-spinner>\r\n</div>\r\n<mat-card class=\"userPermission\">\r\n<mat-card class=\"addFilterCard\"> \r\n  <span class=\"icon-Add-Line\" (click)=\"openPermissionDialog('add')\" matTooltip=\"add permission\" style=\"font-size: 22px;cursor: pointer;margin-left: 7px;\"></span>\r\n  <mat-form-field style=\"margin-left: 20px;\">\r\n    <mat-label>Filter</mat-label>\r\n    <input matInput (keyup)=\"applyFilter($event)\" placeholder=\"user\" autocomplete=\"off\">\r\n  </mat-form-field>\r\n</mat-card> \r\n\r\n<mat-card class=\"permissionListCon\">\r\n  <div class=\"mat-elevation-z8\">\r\n    \r\n    <table mat-table [dataSource]=\"dataSource\" class=\"mat-elevation-z8\" style=\"width: 100%;\">\r\n\r\n  <!-- Position Column -->\r\n  <ng-container matColumnDef=\"id\">\r\n    <th mat-header-cell *matHeaderCellDef> No </th>\r\n    <td mat-cell *matCellDef=\"let element;let i = index\"> {{i+1}} </td>\r\n  </ng-container>\r\n\r\n  <!-- Name Column -->\r\n  <ng-container matColumnDef=\"name\">\r\n    <th mat-header-cell *matHeaderCellDef> Name </th>\r\n    <td mat-cell *matCellDef=\"let element\"> {{element.name}} </td>\r\n    \r\n  </ng-container>\r\n\r\n  <!-- Weight Column -->\r\n  <ng-container matColumnDef=\"mobileNumber\">\r\n    <th mat-header-cell *matHeaderCellDef> phone No. </th>\r\n    <td mat-cell *matCellDef=\"let element\"> {{element.mobileNumber}} </td>\r\n  </ng-container>\r\n\r\n  <!-- Symbol Column -->\r\n  <ng-container matColumnDef=\"edit\">\r\n    <th mat-header-cell *matHeaderCellDef>Edit</th>\r\n    <td mat-cell *matCellDef=\"let element\">\r\n      <mat-icon aria-hidden=\"false\" aria-label=\"Example home icon\" style=\"cursor: pointer;\">more_vert</mat-icon>\r\n     </td>\r\n  </ng-container>\r\n   <!-- Symbol Column -->\r\n   <ng-container matColumnDef=\"delete\">\r\n    <th mat-header-cell *matHeaderCellDef>Delete</th>\r\n    <td mat-cell *matCellDef=\"let element\">\r\n      <mat-icon aria-hidden=\"false\" aria-label=\"Example home icon\" style=\"cursor: pointer;\">delete</mat-icon>\r\n     </td>\r\n  </ng-container>\r\n\r\n  <tr mat-header-row *matHeaderRowDef=\"displayedColumns\"></tr>\r\n  <tr mat-row *matRowDef=\"let row; columns: displayedColumns;\"></tr>\r\n</table>\r\n<mat-paginator [pageSizeOptions]=\"[10, 20]\" showFirstLastButtons></mat-paginator>\r\n</div>\r\n\r\n</mat-card>\r\n\r\n</mat-card>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".gradeMainContainer{\r\n    width: 100%;\r\n    height: calc(100% - 50px);\r\n    background-color: #efefef;\r\n}\r\n.studentListCon{\r\n    height: calc(100% - 85px);\r\n    background-color: #efefef;\r\n}\r\n.studentCardHeader{\r\n    padding: 10px;\r\n    -webkit-box-align: center;\r\n            align-items: center;\r\n    display: -webkit-box;\r\n    display: flex;\r\n}\r\n.gradeMainContainer .mat-elevation-z8{\r\n    box-shadow: unset;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */");
...
var GradesComponent = /** @class */ (function () {
    ...
    GradesComponent.prototype.ngOnInit = function () {
        ...
        this.subscribe = this.route.params.subscribe(function (params) {
            _this.id = params['id'];
            _this.getpermissionUserData();
        });
    };
    GradesComponent.prototype.getpermissionUserData = function () {
        var _this = this;
    ...
    GradesComponent.prototype.openTeacherDialog = function (status, index) {
    ...
    ], GradesComponent.prototype, "paginator", void 0);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".loginMainCon{\r\n    height: 100%;\r\n    width: 100%;\r\n    display: -webkit-box;\r\n    display: flex;\r\n    place-content: center;\r\n    -webkit-box-align: center;\r\n            align-items: center;\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */");
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(router, http, loginService, _snackBar) {
        this.router = router;
        this.http = http;
    ...
    LoginComponent.prototype.ngOnInit = function () {
        ...
        this.http.get("assets/country/countrylist.json").subscribe(function (data) {
            _this.totalList = data;
            _this.totalCountry = Object.keys(data);
            console.log(_this.totalList);
        });
    };
    LoginComponent.prototype.onCountrySelection = function (country) {
        this.totalStates = this.totalList[country];
        this.registerObj.country = country;
        this.totalDist = [];
    };
    LoginComponent.prototype.onStateSelection = function (state) {
        var currentState = this.totalStates.filter(function (e) {
            return e.name == state;
        });
        this.registerObj.state = state;
        if (currentState && currentState.length) {
            this.totalDist = currentState[0].districts;
        }
    };
    LoginComponent.prototype.onDistSelection = function (district) {
        this.registerObj.district = district;
    };
    LoginComponent.prototype.onLoginCountrySelection = function (country) {
        this.totalStates = this.totalList[country];
        this.loginObj.country = country;
        this.totalDist = [];
    };
    LoginComponent.prototype.onLoginStateSelection = function (state) {
        var currentState = this.totalStates.filter(function (e) {
            return e.name == state;
        });
        this.loginObj.state = state;
        if (currentState && currentState.length) {
            this.totalDist = currentState[0].districts;
        }
    };
    LoginComponent.prototype.onLoginDistSelection = function (district) {
        this.loginObj.district = district;
        this.districtSchool();
    };
    LoginComponent.prototype.onLoginschoolSelection = function (school) {
        this.loginObj.schoolName = school;
        this.getSchoolInfo();
    };
    LoginComponent.prototype.getSchoolInfo = function () {
        var _this = this;
        this.loginService.getCurrentSchool(this.loginObj).then(function (res) {
            if (res) {
                _this.currentSchool = res;
            }
        });
    };
    LoginComponent.prototype.districtSchool = function () {
        var _this = this;
        this.isDataLoading = true;
        this.loginService.getAllDistrictSchool(this.loginObj).then(function (res) {
            _this.isDataLoading = false;
            if (res && res.length) {
                _this.allDistricSchool = res;
            }
        });
    };
    LoginComponent.prototype.registerUser = function (value) {
        var _this = this;
        this.loginService.registerUser(this.registerObj).then(function (res) {
            if (res == 'registrated') {
                _this.openSnackBar('User Exist go to Login');
            }
            else {
                _this.openSnackBar('Register Sucessfully');
            }
        });
    };
    LoginComponent.prototype.loginUser = function () {
        if (this.currentSchool && this.loginObj) {
            if (this.loginObj.username == this.currentSchool.username) {
                if (this.loginObj.password == this.currentSchool.password) {
                    delete this.currentSchool.password;
                    localStorage['user_data'] = JSON.stringify(this.currentSchool);
...
/***/ "./src/app/components/permission/addpremission.dialog.ts":
/*!***************************************************************!*\
  !*** ./src/app/components/permission/addpremission.dialog.ts ***!
  \***************************************************************/
...
var DialogAddPermissionDialog = /** @class */ (function () {
    ...
    DialogAddPermissionDialog = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./addpermission.dialog.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/permission/addpermission.dialog.html")).default,
        }),
...
/* harmony import */ var _angular_material_dialog__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/material/dialog */ "./node_modules/@angular/material/__ivy_ngcc__/fesm5/dialog.js");
/* harmony import */ var _addpremission_dialog__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./addpremission.dialog */ "./src/app/components/permission/addpremission.dialog.ts");
/* harmony import */ var _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/fire/firestore */ "./node_modules/@angular/fire/__ivy_ngcc__/firestore/index.js");
...
var PermissionComponent = /** @class */ (function () {
    ...
    PermissionComponent.prototype.openPermissionDialog = function (status, index) {
        var dialogRef = this.dialog.open(_addpremission_dialog__WEBPACK_IMPORTED_MODULE_5__["DialogAddPermissionDialog"], {
            width: '300px',
            minWidth: '250px',
    ...
    PermissionComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        ...
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_4__["MatDialog"], _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_6__["AngularFirestore"]])
    ], PermissionComponent);
...
var DialogAddStudentDialog = /** @class */ (function () {
    ...
    DialogAddStudentDialog.prototype.ngOnInit = function () {
        ...
        if (this.data && this.data.totalData && this.data.ind >= 0) {
            ...
            if (this.data.status == 'update') {
                this.myClassForm = this.fb.group({
                    studentName: [cData.className, [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required]],
                });
            }
        }
    };
    ...
    DialogAddStudentDialog.prototype.submitForm = function () {
        ...
        if (localStorage && localStorage.user_data && localStorage.user_data.length && this.myClassForm.valid) {
            ...
            var ref = this.db.collection('allschool').doc(value.country).collection(value.state).
                doc(value.district).collection(value.schoolName).doc('allClass').collection('Classes').
                doc(this.data.id).collection('students').doc(studentData.rollNumber + '_' + studentData.studentName);
...
/* harmony import */ var _components_permission_addpremission_dialog__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./components/permission/addpremission.dialog */ "./src/app/components/permission/addpremission.dialog.ts");
    ...
    RouteModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [_app_components_mainpage_mainpage_component__WEBPACK_IMPORTED_MODULE_6__["MainpageComponent"],
                ...
                _components_permission_addpremission_dialog__WEBPACK_IMPORTED_MODULE_14__["DialogAddPermissionDialog"],
...
module.exports = __webpack_require__(/*! C:\Users\INFI\Documents\myschool\src\main.ts */"./src/main.ts");
